...
%token GRID GRID_GET GRID_ROTATE
%nonassoc IFX
%nonassoc ELSE
%token <sPtr> VARIABLE
...
$5, $7); }
        ...
        | GRID '[' expr ',' expr ']' '.' GRID_GET '(' expr ')' ';' { $$ = opr(GRID_GET, 3, $3, $5, $10); }
        | GRID '[' expr ',' expr ']' '.' GRID_ROTATE '(' expr ')' ';' { $$ = opr(GRID_ROTATE, 3, $3, $5, $10); }
        | GRID '[' expr ',' expr ']' '=' GRID '[' expr ',' expr ']' ';' { $$ = opr(GRID, 4, $3, $5, $10, $12); }
