...
#line 72 "nas2.y"
                        { lb[(yyvsp[-1].i)] = pc; }
#line 1430 "nas2.tab.c"
    break;

  case 6:
#line 76 "nas2.y"
                        { in[pc] = PUSHI; op[pc++] = (yyvsp[0].i); }
#line 1436 "nas2.tab.c"
    break;
...
#line 1446 "nas2.tab.c"
    break;

  case 8:
#line 82 "nas2.y"
                        { in[pc] = PUSHR; op[pc++] = (yyvsp[0].i); }
#line 1452 "nas2.tab.c"
    break;
...
#line 1464 "nas2.tab.c"
    break;

  case 11:
#line 87 "nas2.y"
                        { in[pc] = POPR; op[pc++] = (yyvsp[0].i); }
#line 1470 "nas2.tab.c"
    break;

  case 12:
#line 89 "nas2.y"
                        { in[pc] = POPRI; op[pc] = (yyvsp[-3].i); opx[pc++] = (yyvsp[-1].i); }
#line 1476 "nas2.tab.c"
    break;

  case 13:
#line 91 "nas2.y"
                        { in[pc] = POPRR; op[pc] = (yyvsp[-3].i); opx[pc++] = (yyvsp[-1].i); }
#line 1482 "nas2.tab.c"
    break;

  case 14:
#line 93 "nas2.y"
                        { in[pc] = CALL; op[pc++] = (yyvsp[0].i); }
#line 1488 "nas2.tab.c"
    break;

  case 15:
#line 94 "nas2.y"
                        { in[pc++] = RET; }
#line 1494 "nas2.tab.c"
    break;

  case 16:
#line 95 "nas2.y"
                        { in[pc++] = END; }
#line 1500 "nas2.tab.c"
    break;

  case 17:
#line 96 "nas2.y"
                        { in[pc++] = LT; }
#line 1506 "nas2.tab.c"
    break;

  case 18:
#line 97 "nas2.y"
                        { in[pc++] = GT; }
#line 1512 "nas2.tab.c"
    break;

  case 19:
#line 98 "nas2.y"
                        { in[pc++] = GE; }
#line 1518 "nas2.tab.c"
    break;

  case 20:
#line 99 "nas2.y"
                        { in[pc++] = LE; }
#line 1524 "nas2.tab.c"
    break;

  case 21:
#line 100 "nas2.y"
                        { in[pc++] = NE; }
#line 1530 "nas2.tab.c"
    break;

  case 22:
#line 101 "nas2.y"
                        { in[pc++] = EQ; }
#line 1536 "nas2.tab.c"
    break;

  case 23:
#line 102 "nas2.y"
                        { in[pc] = J0; op[pc++] = (yyvsp[0].i); }
#line 1542 "nas2.tab.c"
    break;

  case 24:
#line 103 "nas2.y"
                        { in[pc] = J1; op[pc++] = (yyvsp[0].i); }
#line 1548 "nas2.tab.c"
    break;

  case 25:
#line 104 "nas2.y"
                        { in[pc] = JMP; op[pc++] = (yyvsp[0].i); }
#line 1554 "nas2.tab.c"
    break;

  case 26:
#line 105 "nas2.y"
                        { in[pc++] = ADD; }
#line 1560 "nas2.tab.c"
    break;

  case 27:
#line 106 "nas2.y"
                        { in[pc++] = SUB; }
#line 1566 "nas2.tab.c"
    break;

  case 28:
#line 107 "nas2.y"
                        { in[pc++] = MUL; }
#line 1572 "nas2.tab.c"
    break;

  case 29:
#line 108 "nas2.y"
                        { in[pc++] = DIV; }
#line 1578 "nas2.tab.c"
    break;

  case 30:
#line 109 "nas2.y"
                        { in[pc++] = MOD; }
#line 1584 "nas2.tab.c"
    break;

  case 31:
#line 110 "nas2.y"
                        { in[pc++] = NEG; }
#line 1590 "nas2.tab.c"
    break;

  case 32:
#line 111 "nas2.y"
                        { in[pc++] = AND; }
#line 1596 "nas2.tab.c"
    break;

  case 33:
#line 112 "nas2.y"
                        { in[pc++] = OR; }
#line 1602 "nas2.tab.c"
    break;

  case 34:
#line 113 "nas2.y"
                        { in[pc++] = GETI; }
#line 1608 "nas2.tab.c"
    break;

  case 35:
#line 114 "nas2.y"
                        { in[pc++] = GETS; }
#line 1614 "nas2.tab.c"
    break;

  case 36:
#line 115 "nas2.y"
                        { in[pc++] = GETC; }
#line 1620 "nas2.tab.c"
    break;

  case 37:
#line 116 "nas2.y"
                        { in[pc++] = PUTI; }
#line 1626 "nas2.tab.c"
    break;

  case 38:
#line 117 "nas2.y"
                        { in[pc++] = DBI; }
#line 1632 "nas2.tab.c"
    break;
...
#line 1642 "nas2.tab.c"
    break;

  case 40:
#line 123 "nas2.y"
                        { in[pc++] = PUTS; }
#line 1648 "nas2.tab.c"
    break;
...
#line 1658 "nas2.tab.c"
    break;

  case 42:
#line 129 "nas2.y"
                        { in[pc++] = PUTC; }
#line 1664 "nas2.tab.c"
    break;
...
#line 1674 "nas2.tab.c"
    break;

  case 44:
#line 135 "nas2.y"
                        { in[pc++] = PUTI_; }
#line 1680 "nas2.tab.c"
    break;

  case 45:
#line 136 "nas2.y"
                        { in[pc++] = PUTS_; }
#line 1686 "nas2.tab.c"
    break;

  case 46:
#line 137 "nas2.y"
                        { in[pc++] = PUTC_; }
#line 1692 "nas2.tab.c"
    break;
...
#line 1700 "nas2.tab.c"
    break;


#line 1704 "nas2.tab.c"
